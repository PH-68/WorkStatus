<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WorkStatus.v3.Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title><%=WorkStatus.Properties.LanguageResource.ws %> | V3</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="h-100 container">
            ...
            <a class="btn btn-outline-danger form-group" href="../v2/">Go to older version.</a>
            <a href="?changetheme=true" class="btn btn-outline-info form-group">Switch the theme</a>
        </div>
        <footer class="small text-center form-group"><small class="text-muted">Build : γ-0.0.2.0-Early-access</small></footer>
    </form>
    <%Response.Redirect("../"); %>
</body>
</html>
