...
namespace WorkStatus
{
    public partial class Default : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //js.Attributes["src"] = "Improve_Table_theme.js";
            ...
            {
                Label_1.Text = Application["EV3HtmlTable"].ToString().Replace("。",".");
                css.Attributes["href"] = "Improve_Table_en.css";
            }
            Page.Header.Controls.Add(css);
            js.Attributes["type"] = "text/javascript";
            if (Request.Cookies["V3theme"] == null)
            {
                Response.Cookies["V3theme"].Value = "light";
                js.Attributes["src"] = "Improve_Table_Light.js";
                Page.Header.Controls.Add(js);
                Response.Cookies["V3theme"].Expires = DateTime.UtcNow.AddYears(999);
            }

            if (Request.QueryString["changetheme"] == "true")
            {
                if (Request.Cookies["V3theme"].Value == "light")
                {
                    js.Attributes["src"] = "Improve_Table_Dark.js";
                    Page.Header.Controls.Add(js);
                    Response.Cookies["V3theme"].Value = "dark";
                    Response.Cookies["V3theme"].Expires = DateTime.UtcNow.AddYears(999);
                }
                else
                {
            ...
            else if (Request.Cookies["V3theme"].Value == "dark")
            {
                js.Attributes["src"] = "Improve_Table_Dark.js";
                Page.Header.Controls.Add(js);
            }
